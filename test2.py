...
""",
        ...
        completion(model="llama-3.3-70b-versatile", messages=[session_message], api_key=settings.GROQ_API_KEY.get_secret_value(), base_url="https://api.groq.com/openai/v1")
...
async def chat(message_data: ChatMessage):
    ...
    try:
        ...
        # Process the message with user's memory using Groq
        response = completion(
            model="llama-3.3-70b-versatile",
