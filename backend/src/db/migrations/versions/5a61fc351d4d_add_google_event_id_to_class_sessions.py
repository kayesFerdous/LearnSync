"""add google_event_id to class_sessions

Revision ID: 5a61fc351d4d
Revises: 702de27d4d97
Create Date: 2026-02-01 20:34:53.345195
...
revision: str = '5a61fc351d4d'
down_revision: Union[str, Sequence[str], None] = '702de27d4d97'
...
def upgrade() -> None:
    ...
    op.add_column('class_sessions', sa.Column('google_event_id', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('class_sessions', 'google_event_id')
