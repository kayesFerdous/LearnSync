"""add icon and color in folder table

Revision ID: cd18245b619a
Revises: bc80400017ee
Create Date: 2026-01-30 16:55:03.695997
...
revision: str = 'cd18245b619a'
down_revision: Union[str, Sequence[str], None] = 'bc80400017ee'
...
def upgrade() -> None:
    ...
    op.alter_column('files', 'conversation_id',
               ...
               nullable=True)
    op.add_column('folders', sa.Column('icon', sa.String(length=255), nullable=True))
    op.add_column('folders', sa.Column('color', sa.String(length=255), nullable=True))
