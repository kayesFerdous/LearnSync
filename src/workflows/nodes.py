...
# from src.core.calendar_toolkit import get_user_tools 
...
#         if not user_id:
#             return {'messages': [AIMessage(content="User ID is missing from the state. Cannot access calendar.")]}
#
#         tools = await get_user_tools(user_id)
#         if not tools:
#              return {'messages': [AIMessage(content="Could not initialize calendar tools. Please check your connection or login status.")]}
#
