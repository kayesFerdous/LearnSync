"""add font field in user_settings

Revision ID: 80d8dd87ffef
Revises: 9f933760f328
Create Date: 2026-01-24 09:46:34.814576
...
revision: str = '80d8dd87ffef'
down_revision: Union[str, Sequence[str], None] = '9f933760f328'
...
def upgrade() -> None:
    ...
    op.add_column('user_settings', sa.Column('font', sa.String(), nullable=False, server_default='system'))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('user_settings', 'font')
