"""add folders and files table

Revision ID: bc80400017ee
Revises: 80d8dd87ffef
Create Date: 2026-01-28 15:35:42.288505
...
revision: str = 'bc80400017ee'
down_revision: Union[str, Sequence[str], None] = '80d8dd87ffef'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_documents_user_id_users'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_folders_user_id_users'), ondelete='CASCADE'),
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['conversation_id'], ['conversations.id'], name=op.f('fk_files_conversation_id_conversations'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['folder_id'], ['folders.id'], name=op.f('fk_files_folder_id_folders'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], name=op.f('fk_files_user_id_users'), ondelete='CASCADE'),
    ...
    op.create_foreign_key(op.f('fk_conversations_folder_id_folders'), 'conversations', 'folders', ['folder_id'], ['id'], ondelete='SET NULL')
