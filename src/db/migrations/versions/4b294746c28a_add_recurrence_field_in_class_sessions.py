"""add recurrence field in class_sessions

Revision ID: 4b294746c28a
Revises: 21de09420b9f
Create Date: 2026-02-01 16:08:04.616312
...
revision: str = '4b294746c28a'
down_revision: Union[str, Sequence[str], None] = '21de09420b9f'
...
def upgrade() -> None:
    ...
    op.add_column('class_sessions', sa.Column('recurrence', postgresql.ARRAY(sa.String()), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('class_sessions', 'recurrence')
