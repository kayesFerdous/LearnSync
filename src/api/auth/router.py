...
# # from src.user.crud import get_or_create_user
#
...
#     failure_redirect_url = f"{FRONTEND_URL}?error=authentication_failed"
#
#     try:
...
#         response = RedirectResponse(url=f"{FRONTEND_URL}?status=success")
#         response.set_cookie(
