  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className={`flex flex-col min-w-0 relative transition-all duration-300 ${
        ...
        <div className={`flex flex-col h-full ${!selectedPdf ? 'p-4 md:p-6' : 'p-4'}`}>
          {/* Header */}
          <div className="shrink-0 py-4 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-secondary text-secondary-foreground text-sm font-medium border border-border theme-shadow hover:theme-shadow-md transition-all duration-200">
          ...
          {/* Messages Area */}
          <div className="flex-1 overflow-y-auto py-4 space-y-6 pb-32 scroll-smooth scrollbar-hide px-4">
            {messages.map((msg) => (
              <ChatMessage
                key={msg.id}
                message={msg}
