...
export const useQuizStore = create<QuizState>((set, get) => ({
    ...
    loadQuiz: async (quizId: string) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/mcq/${quizId}`, {
                method: 'GET',
    ...
    generateQuiz: async (request: QuizGenerationRequest) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/mcq/generate`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
                credentials: "include",
    ...
    saveScore: async (quizId: string, score: number) => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/mcq/${quizId}/score`, {
                method: 'PATCH',
                headers: { 'Content-Type': 'application/json' },
                credentials: 'include',
